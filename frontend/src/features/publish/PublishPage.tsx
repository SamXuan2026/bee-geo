                ...
                <tr key={item.id}>
                  ...
                  <td>
                    <div className="table-actions">
                      ...
                      <button className="link-button" type="button" onClick={() => retryTask(item)}>重试</button>
                      <button className="danger-link" type="button" onClick={() => setRevokeTarget(item)}>撤回</button>
                    </div>
                  </td>
                </tr>
              ))}
        ...
        <Modal
          ...
          footer={
            <>
              ...
              <button className="primary-button" type="button" onClick={submitTask} disabled={saving}>
                {saving ? "保存中" : "保存任务"}
              </button>
            </>
          }
