                ...
                <tr key={item.id}>
                  ...
                  <td>
                    <div className="table-actions">
                      <button className="link-button" type="button" onClick={() => openAuth(item)}>重新授权</button>
                      <button className="danger-link" type="button" onClick={() => setExpireTarget(item)}>标记过期</button>
                    </div>
                  </td>
                </tr>
              ))}
        ...
        <Modal
          ...
          footer={
            <>
              ...
              <button className="primary-button" type="button" onClick={submitCredential} disabled={saving}>
                {saving ? "保存中" : "加密保存"}
              </button>
            </>
          }
