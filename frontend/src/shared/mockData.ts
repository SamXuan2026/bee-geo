...
export const creationItems: CreationItem[] = [
  { id: 1, title: "2026 年 IM 即时通讯方案选型实践", brand: "BeeWorks", platform: "自有站点", publishAt: "2026-04-30 09:00", status: "APPROVED" },
  { id: 2, title: "企业协同平台如何提升组织效率", brand: "BeeWorks", platform: "免费媒体", publishAt: "2026-04-30 14:00", status: "PENDING_REVIEW" },
  { id: 3, title: "GEO 内容运营方法论", brand: "BeeWorks", platform: "全部平台", publishAt: "未设置", status: "DRAFT" },
];
